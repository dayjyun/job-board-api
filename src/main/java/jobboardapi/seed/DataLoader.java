...
//            user2.setBusinessList(businessListKevin);
//            user3.setBusinessList(businessListKim);
//
...
//            user2.setJobList(jobListKim);
//            user3.setJobList(jobListDeShe);
//
//            // doesn't work
...
//            job1.getApplicantsList().add(user3); // Kim applied for DeShe's Job
//            job2.getApplicantsList().add(user1); // DeShe applied for Kevin's Job
//            job3.getApplicantsList().add(user2); // Kevin applied for Kim's Job
